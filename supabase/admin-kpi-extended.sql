-- MoviQ — RPC admin_kpi_extended()
-- Restituisce KPI estesi su subscription, KYC, email deliverability, coupon, prenotazioni.
-- Sicurezza: security definer + check claim app_metadata.role='admin'.
